...
class IahrsDriver(Node):
    ...
    def __init__(self):
        ...
        self.port_name = self.get_parameter_or('port.name', Parameter('port.name', Parameter.Type.STRING, '/dev/ttyIMU')).get_parameter_value().string_value
        self.baud_rate = self.get_parameter_or('port.baudrate', Parameter('port.baudrate', Parameter.Type.INTEGER, 115200)).get_parameter_value().integer_value
